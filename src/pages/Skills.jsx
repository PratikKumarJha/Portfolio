...
const SKILLS = [
  ...
  { name: "VSCode", logo: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/visualstudio/visualstudio-original.svg" },
  { name: "Selenium", logo: "https://upload.wikimedia.org/wikipedia/commons/9/9f/Selenium_logo.svg" },
];
...
const ROWS = [
  [
    ...
    { title: "Frameworks & Libraries", items: ["NodeJs", "Express", "React Native", "Angular"] },
  ],
  [
    {
      title: "Core Concepts",
    ...
    {
      title: "Soft Skills",
      items: ["Problem Solving", "Creativity", "Teamwork",  "Adaptability", "Communication"],
    },
  ],
];
