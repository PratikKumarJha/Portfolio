...
export default function Blog() {
  const defaultPosts = [
    {
      id: 1,
      title: "Why I Love Building the Projects",
      text: "Problem-Solving and Innovation are at the heart of my passion for building. I love the challenge of taking a complex idea and breaking it down into manageable components, then creating a tangible solution that addresses a real-world need. The process of designing, iterating, and seeing a project come to life is incredibly rewarding.",
    },
    {
      id: 2,
